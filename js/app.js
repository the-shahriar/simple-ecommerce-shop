...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
        ...
        const slicedTitle = title.slice(0, 45);
        ...
        <div class="single-product">
            ...
            <h6 class="product-rating">Rating: ${product.rating.rate}</h6>
            <h6 class="total-rating">Total Review: ${product.rating.count}</h6>
...
const updatePrice = (id, value) => {
    ...
    const total = parseFloat(convertedOldPrice + convertNewPrice);
